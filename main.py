...
def send_vistttt(uid):
    try:
        ...
        api_url = f"https://visit.vercel.app/bd/{uid}"
...
[B][C][00FF00]S 1 XㅤTEAMㅤBYㅤAMINE
[ff0000]━━━━━━━━━━━━━━━━━━━━━
[B][C][FF9900]D O N EㅤH A C K I N G
[B][C][E75480]Y O U RㅤA C C O U N T
[81DACA]━━━━━━━━━━━━━━━━━━━━━
[B][C][FF0000]IㅤAM ㅤS1X	AMINE
[CCFFCC]━━━━━━━━━━━━━━━━━━━━━
[B][C][81DACA]S1X ㅤTEAM ㅤYNYKㅤ ALKOL
[FFFF00]━━━━━━━━━━━━━━━━━━━━━
[B][C][00FF00]F O L L O WㅤM EㅤI NㅤI N S T A G R A Mㅤ[FFFFFF]@mohamed_amin_dahbi
[00008B]━━━━━━━━━━━━━━━━━━━━━
...
[FFD700]👑 NAME : [FFFF00]S1X MASRY
[FFD700]📌 INSTAGRAM : [00BFFF]@3mk_eg
[FF1493]╚══════════════════════════╝""", idinv
                            )
                    )
                    senthi = False
...
S 1 XㅤㅤCOMMUNITY     BOTㅤㅤㅤㅤ

[33FFF3][c][b]-----------------------------------
                     
[FFA500َ][c][b]مرحبأ بك عزيزي المستخدم ارى 
انك تريد اغٓتٓصآب السيرفير 

بواسطه بوت S1X 

[11EAFDَ][bَ][c]لرؤية الأوامر اكتب :

[99FF80َ][c][b]ِ /hِeِlِp


[33FFF3][c][b]-----------------------------------

[b][c][00FFFF]╏تابع المطور على: 

INSTAGRAM :@mohamed_amin_dahbi
...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]3MK AMINE
[FFD700]⚡ INSTAGRAM : [FFFFFF]@mohamed_amin_dahbi
[FFD700]✨ Telegram : [FFFFFF]@S1X_AMINE
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> S1X  TEAM ⚡""", uid
                            )
                        )
                    except Exception as e:
...
[FFD700]✨ Developer —͟͞͞ </> S 1 X 	TEAM ⚡""",
                                    uid
                                )
                            )
...
#-------------------------------------------------------------#          
                if "1200" in data.hex()[0:4] and b"[FFFFF00]MASRY  [ffffff]S1X" in data:
                    pass
                else:
...
with open('amine_token.txt', 'r') as file:
    data = json.load(file)
